<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    <h3 class="mb-0 h-font">AD WEBSITE</h3>
    <a href="logout.php" class="btn btn-light btn-sm">Odhlásit se</a>
</div>
...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid flex-lg-column align-items-stretch h-100">
            ...
            <div class="collapse navbar-collapse d-lg-flex flex-column align-items-stretch mt-2 w-100 flex-grow-1" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="user_queries.php">Dotazy uživatelů</a>
                    </li>
                        <li class="nav-item">
