...
function add_facility()
{
    ...
    xhr.onload = function()
    {
        ...
        {
            alert('error', 'Pouze SVG obrázky jsou povoleny');
        }
        else if(this.responseText == 'inv_size')
        {
            alert('error', 'Obrázek musí mít méně než 1 Mb');
        }
        ...
        {
            alert('success', 'Nový popis přidán');
...
function rem_facility(val)
{
    ...
    xhr.onload = function()
    {
        if(this.responseText==1)
        {
            alert('success', 'Ppopis vymazán');
            get_facilities();
        }

        else if(this.responseText== 'room_added')
        {
            alert('error', 'Popis je přídán do popisu!');
        }
