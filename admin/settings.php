            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                        ...
                        <form id="general_s_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Název stránky</label>
                                        <input type="text" name="site_title" id="site_title_inp" class="form-control shadow-none" required>
                                    </div>
                                     <div class="mb-3">
                                        <label class="form-label fw-bold">O nás</label>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Žádný zákazník si nebude moci rezervovat hotel, když je zapnutý režim vypnutí.
                        </p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Nastavení kontaktů</h5>
                        ...
                        <div class="row">
                            <dic class="col-lg-6">
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Adresa</h6>
                                    <p class="card-text" id="address"></p>
                                </div>
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Google mapa</h6>
                                    <p class="card-text" id="gmap"></p>
                                </div>
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Telefonní číslo</h6>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Sociální sítě</h6>
                                    <p class="card-text mb-1">
                                ...
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Vložené okno</h6>
    ...
    <script>
        ...
        function upd_shutdown(val)
        {
            ...
            xhr.onload = function()
            {
                ...
                {
                    alert('success', 'Web byl vypnut');
                }
                else
                {
                    alert('success', 'Web byl zapnut');
                }
                get_general();
            }
