                        ...
                        <form>
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Zavřit</button>
                                    <button type="button" class="btn custom-bg text-white shadow-none">Potvrdit</button>
                                </div>
                            </div>
                        </form>
                    </div>
