<?php
    ...
    if(isset($_GET['email_confirmation']))
    {
        ...
        if(mysqli_num_rows($query)==1)
        {
            ...
            {
                echo "<script>alert('Email již ověřen!')</script>";
            }
            else
            {
                ...
                if($update)
                {
                    echo "<script>alert('Ověření emailu bylo úspěšné!')</script>";
                }
                else
                {
                    echo "<script>alert('Ověření emailu selhalo! Server selhal')</script>";
                }
            }
            redirect('index.php');
        }
        ...
        {
            echo "<script>alert('Neplatný odkaz!')</script>";
            redirect('index.php');
        }
    }
