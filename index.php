...
<body class="bg-light">
    ...
    <!-- Testimonials -->
    <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">Recenze</h2>
                ...
                <form id="recovery-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-shield-lock fs-3 me-2"></i> Nastavení nového hesla
                        </h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-2 text-end">
                            <button type="button" class="btn shadow-none me-2" data-bs-dismiss="modal"> Zrušit </button>
                            <button type="submit" class="btn btn-dark shadow-none">Potvrdit</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        recovery_form.addEventListener('submit', (e)=> 
        {
            ...
            xhr.onload = function()
            {
                ...
                {
                    alert('error', "Resetování účtu selhalo.");
                }
                else
                {
                    alert('success', "Reset účtu byl úspěšný!");
                    recovery_form.reset();
                }
            }
            xhr.send(data);
